...
import com.projectmanage.Adapters.CheckListAdapter;
import com.projectmanage.Models.CheckListObject;
import com.projectmanage.R;
import com.projectmanage.Activities.Settings.SharedPreferencesManager;
...
public class TaskInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // taskNoteEdit.setTextSize(mSharedPrefManager.getVariable());
        ...
        mDatabaseTask = FirebaseDatabase.getInstance().getReference().child("Projects").child(projectKey).child("Tasks").child(taskState);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_done) {
            ...
            adapter.updateList(projectKey,taskKey,taskState);
            finish();
        }
    ...
    public void setRecyclerView(){
        ...
        adapter = new CheckListAdapter(checkListTexts, TaskInfoActivity.this);
